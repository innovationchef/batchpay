CREATE TABLE IF NOT EXISTS PAIN_001_INCOMING (
    TID INTEGER NOT NULL,
    CREATED_AT TIMESTAMP,
    UPDATED_AT TIMESTAMP,
    AMOUNT DECIMAL(19,2),
    CHARGE_BEARER VARCHAR(255),
    CDTR_ACC_NO VARCHAR(14),
    CURRENCY VARCHAR(3),
    DBTR_ACC_NO VARCHAR(14),
...
CREATE TABLE IF NOT EXISTS CUSTOMER_INCOMING (
    TID INTEGER NOT NULL,
    CREATED_AT TIMESTAMP,
    UPDATED_AT TIMESTAMP,
