...
@Log4j2
@RestController
public class CustJobController extends BaseController {

    private String filepath;

    public CustJobController(@Value("${batchpay.config.filepath}") String filepath,
                             @Qualifier(BatchConstant.CUST_JOB_NAME) Job job,
